...
export default function Header() {
  return (
    <header id="about" className="animate-fade-in pt-6 max-sm:pt-2 pb-8">
      <div className="flex max-sm:flex-col-reverse gap-10 max-sm:gap-6">
        ...
        <HalftonePhoto src={SITE.photo} alt={SITE.name} size={168} cell={5} className="rounded-lg shrink-0 max-sm:mx-auto" />
      </div>
