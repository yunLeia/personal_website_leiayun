  ...
  return (
    <header id="about" className="portfolio-intro portfolio-enter">
      <div className="intro-copy">
        ...
        <p>At <a href="#experience" onClick={(event) => { event.preventDefault(); document.getElementById('experience')?.scrollIntoView({ behavior: window.matchMedia('(prefers-reduced-motion: reduce)').matches ? 'instant' : 'smooth' }); }}>TikTok</a>, I built AI-powered workflows. Previously at <a href="/work/planfit">Planfit</a>, I owned features end-to-end and ran 40+ experiments to improve activation and conversion.</p>
